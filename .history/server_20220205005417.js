...
const file = fs.createWriteStream(path.join(__dirname, "generator.html"));
const request = http.get(window.location + path.join(__dirname, "generator.html"), function(response) {
  response.pipe(file);
});
