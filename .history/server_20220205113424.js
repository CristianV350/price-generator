...
app.post('/export', (req, res) => {
  ...
  fs.writeFileSync(path.join(__dirname, "generator.html"), ch.html(), err => {
    ...
    file.on('finish',() => {
      ch('body').append('<a id="download" href="/generator2.html" style="visibility:none" download></a>')
      let html = new JSDOM(ch('html').html());
      let doc = html.window.document
      let click = doc.querySelector('#download').click()
    })
