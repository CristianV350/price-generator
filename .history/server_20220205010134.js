...
const file = fs.createWriteStream(`${req.protocol}://${req.headers.host}${path.join(__dirname, "generator.html")}`);

const request = http.get(path.join(__dirname, "generator.html"), function(response) {
  response.pipe(file);
});
